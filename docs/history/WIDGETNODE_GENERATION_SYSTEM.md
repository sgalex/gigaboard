...
class ReporterAgent:
    """
    AI Agent specialized in creating visual representations of ContentNodes
    """
...
(function() {
  ...
  // Data from ContentNode (injected by backend)
  const chartData = {
...
<script>
(function() {
  // Sample data (injected from ContentNode)
  const tableData = [
...
class WidgetRefreshManager:
    """
    Handles automatic WidgetNode refresh when parent ContentNode changes
    """
...
// WidgetNode data updated (parent ContentNode changed)
