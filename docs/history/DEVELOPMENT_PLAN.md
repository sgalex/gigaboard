...
- [x] Broadcast events:
  - source_node_created/updated/deleted
...
1. **CreateSourceNodeDialog** (2-3 дня)
...
2. **CreateWidgetNodeDialog** (1 день)
   - [ ] Форма: parent_source_node (select), user_prompt (textarea)
...
- [ ] EditSourceNodeDialog, EditWidgetNodeDialog, EditCommentNodeDialog
- [ ] Error handling
...
**День 2-3 (28-29.01):**
- [ ] 🔴 ЗАДАЧА B.1: CreateSourceNodeDialog
...
**День 5-6 (7-8.02):**
- [ ] Node improvements:
  - SourceNode: Preview data button → modal
...
**Deliverable:** AI может генерировать виджеты из ContentNode

---

### 🎯 SPRINT 4: Transformation Agent (10-23 мар, 2 недели)
**Цель:** ContentNode → ContentNode трансформации
...
- ✅ SourceNode/ContentNode/WidgetNode/CommentNode CRUD (done)
...
2. **Вторник-Среда:** CreateSourceNodeDialog
