...
**Секции:**
- Недавние проекты, Избранные.
- Кнопки: «Создать проект», «Импорт проекта/данных».
- Шаблоны: «Пустой», «Продажи», «Маркетинг», «Финансы», «Из CSV/DB».

**Импорт:**
- Из архива/репо/URL; быстрый коннект источников.

**Быстрый старт:**
- «Открыть последнюю доску», «Запустить туториал», «Подключить источник».
