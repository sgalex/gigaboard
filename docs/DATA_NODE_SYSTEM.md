...
- **SourceNode** — точка входа данных, создаётся пользователем (файл, API, БД, Поиск с ИИ, ручной ввод)
...
| `research` | Поиск с ИИ             | Multi-agent deep research (search → research → analyze)   |
