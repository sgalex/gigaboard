...
GigaBoard построен на парадигме **Data-Centric Canvas** — вместо размещения виджетов на канвасе, система работает с **узлами данных** и их **трансформациями**. Это превращает GigaBoard из инструмента визуализации в **платформу для создания и автоматизации data pipelines** с AI-ассистентом.
...
- Произвольный Python код, сгенерированный Transformation Agent
...
→ Transformation Agent генерирует:
