...
**Последняя актуализация**: 2026-03-01 (Dashboard System, Cross-Filter, Multi-Agent System, проектное дерево).
...
**Экран:** Логин → пустой холст. Слева — проектное дерево: раздел **«Источники данных»** с витриной (CSV, JSON, Excel, API, БД, Поиск с ИИ, ручной ввод и др.).
...
**Краткий обзор остальных (15 сек).** Камера пробегается по витрине: JSON, REST API, ручной ввод, Поиск с ИИ.

**Голос:**
> *"Также поддерживаются JSON, REST API с авторизацией, ручной ввод таблиц — и Поиск с ИИ: задаёшь тему, агент сам ищет данные в интернете и структурирует их в SourceNode. Все источники работают одинаково — дальше тот же canvas, те же трансформации."*
