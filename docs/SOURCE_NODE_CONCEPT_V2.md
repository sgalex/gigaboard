...
**Специфика**: Как JSON, но с табами для листов.

```
┌─────────────────────────────────────────────────────────────────────────────┐
│ 📗 Excel — report_2024.xlsx                                           [✕]  │
├────────────────────────────────────┬────────────────────────────────────────┤
│                                    │                                        │
│  📎 report_2024.xlsx (3.5 MB)      │  [📊 Таблицы] [🐍 Python код]          │
│                                    │                                        │
│  ┌─ Листы файла ──────────────────┐│  ═══ Таблицы ══════════════════════════│
│  │                                ││                                        │
│  │  [Продажи] [Клиенты] [Сводка]  ││  [merged_data]                         │
│  │                                ││                                        │
│  │  ── Лист: Продажи ──           ││  | date   | product | client_name |   │
│  │  | Дата   | Товар  | Сумма  |  ││  |--------|---------|-------------|   │
│  │  | 01.01  | Widget | 15000  |  ││  | 01.01  | Widget  | ООО "Рога"  |   │
│  │  | ...    | ...    | ...    |  ││  | ...    | ...     | ...         |   │
│  │                                ││                                        │
│  │  Строк: 1,500 | Столбцов: 8    ││  ─────────────────────────────────────  │
│  └────────────────────────────────┘│                                        │
│                                    │  ┌─ AI Ассистент ─────────────────────┐│
│                                    │  │                                    ││
│                                    │  │ 💬 Опишите что извлечь:            ││
│                                    │  │ ┌────────────────────────────────┐ ││
│                                    │  │ │ Объедини Продажи и Клиенты    │ ││
│                                    │  │ │ по полю client_id             │ ││
│                                    │  │ └────────────────────────────────┘ ││
│                                    │  │                        [Отправить] ││
│                                    │  │                                    ││
│                                    │  │ 📋 Рекомендации:                   ││
│                                    │  │ • Лист "Продажи" → таблица         ││
│                                    │  │ • Лист "Клиенты" → таблица         ││
│                                    │  │ • Объединить по client_id          ││
│                                    │  │                                    ││
│                                    │  │ [🔮 Авто]  [▶ Выполнить]           ││
│                                    │  └────────────────────────────────────┘│
│                                    │                                        │
...
```json
{
  ...
  "config": {
    ...
    "extraction_code": "import pandas as pd\ndf = pd.read_excel(file, sheet_name='Продажи')\n..."
  }
}
```
