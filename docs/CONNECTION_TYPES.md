...
- **Executable code**: Contains Python transformation code generated by **TransformCodexAgent** / transformation pipeline
...
1. TransformCodex / transformation pipeline analyzes:
...
- **Code-based**: WidgetNode contains fully custom HTML/CSS/JS generated by **WidgetCodexAgent**
...
WidgetCodex / виджет-пайплайн создаёт визуализации (пример):
